...
function AppRoutes() {
  ...
  return (
    <Routes>
      <Route path="/" element={user ? <Navigate to={user.role === 'ADMIN' ? '/admin/dashboard' : '/employee/dashboard'} replace /> : <Landing />} />
      <Route path="/admin/login" element={user ? <Navigate to="/admin/dashboard" replace /> : <LoginPage role="admin" />} />
      <Route path="/employee/login" element={user ? <Navigate to="/employee/dashboard" replace /> : <LoginPage role="employee" />} />
