  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen">
      ...
      <div className="w-full lg:w-1/2 bg-white flex flex-col justify-center px-8 sm:px-16 py-12 lg:py-0">
        ...
        <p className="text-text-secondary mb-8">Select your portal to securely access the system.</p>
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <ArrowRight size={20} className="text-text-secondary group-hover:text-primary transition-colors" />
          </button>
        ...
        <p className="text-sm text-text-secondary mt-12">&copy; 2026 Mahiul Hasan Anik. All rights reserved.</p>
      </div>
    </div>
  );
}
