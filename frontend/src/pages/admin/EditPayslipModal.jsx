...
export default function EditPayslipModal({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(getApiError(err, "Failed to update payslip"));
    } finally {
      setLoading(false);
    }
  };
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            type="submit"
            disabled={loading}
            className="cursor-pointer active:scale-95 px-5 py-2.5 bg-primary hover:bg-primary-hover text-white rounded-lg text-sm font-medium transition-colors disabled:opacity-50"
          >
